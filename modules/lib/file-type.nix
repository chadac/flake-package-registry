# This is fairly blatantly copied from home-manager
#
# https://github.com/nix-community/home-manager/blob/f2942f3385f1b35cc8a1abb03a45e29c9cb4d3c8/modules/lib/file-type.nix
#
# Using it because it's a really cool type.
{ lib, pkgs }:
    ...
    types.attrsOf (types.submodule ({ name, config, ... }: {
      options = {
        ...
        target = mkOption {
          ...
          description = ''
            Path to target file relative to the project root directory.
          '';
        };
